...
def get_all_workouts():
    ...
    workouts = db(q).select(orderby=db.userWorkout.dayOfWeek_id)  # this asks the database for ALL entries in the userPlan table
    workouts_list = []
...
@auth.requires_login()
def get_all_answers():
    q = (db.userAnswers.userPlan_id == request.vars.planID)  # gets all the userPlan for the current user
    answers = db(q).select()  # this asks the database for ALL entries in the userPlan table
    answers_list = []

    for answer in answers:
        answers_to_send = dict(
            answer_id =answer.answer_id,
            userplan_id = answer.userPlan_id,
            question_id = answer.question_id,
        )
        answers_list.append(answers_to_send)

    return response.json(
        dict(answers=answers_list))  # return all movies as a JSON object back to JavaScript as variable called workoutss
...
def Save_Plan():
                ...
                [
                    [
                        [   #freq1, 1-1  Monday, Cardio, Lose Weight
                            [1,1,"Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.bodybuilding.com/content/5-stretches-every-lifter-needs-to-do.html"],
                    ...
                    [
                        [   #freq1, 2-1  Monday, Weightlifting, Lose Weight
                            [1,1,"Rotator Cuff Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.youtube.com/watch?v=bT8RNbaNd7U"],
                ...
                [
                    [
                        [   #freq2, 1-1  Monday + Friday, Cardio, Lose Weight
                            ...
                            [1,7,"Walk", "for 5 more minutes","https://www.bodybuilding.com/exercises/walking-treadmill"],
                            #FRIDAY BEGIN
                            [5,1,"Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.bodybuilding.com/content/5-stretches-every-lifter-needs-to-do.html"],
                    ...
                    [
                        [   #freq2, 2-1  Monday + Friday, Weightlifting: Lose Weight:
                            ...
                            [1,8,"Spider Curl", "4 sets 12 reps","https://www.bodybuilding.com/exercises/spider-curl"],
                            #FRIDAY BEGIN
                            [5,1,"Rotator Cuff Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.youtube.com/watch?v=bT8RNbaNd7U"],
                ...
                [
                    [
                        [   #freq3, 1-1  Monday + Friday + Wednesday, Cardio, Lose Weight
                            ...
                            [5,6,"Walk", "for 5 more minutes","https://www.bodybuilding.com/exercises/walking-treadmill"],
                            #WEDNESDAY BEGIN
                            [3,1,"Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.bodybuilding.com/content/5-stretches-every-lifter-needs-to-do.html"],
                    ...
                    [
                        [   #freq3, 2-1  Monday + Friday + Wednesday, Weightlifting: Lose Weight:
                            ...
                            [5,7,"Tricep Pulldown", "4 sets 12 reps","https://www.bodybuilding.com/exercises/reverse-grip-triceps-pushdown"],
                            #WEDNESDAY BEGIN
                            [3,1,"Rotator Cuff Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.youtube.com/watch?v=bT8RNbaNd7U"],
                            [3,2,"One Arm Dumbell Press","4 sets 12 reps","https://www.bodybuilding.com/exercises/standing-palm-in-one-arm-dumbbell-press"],
                            [3,3,"Reverse Fly","3 sets 15 reps","https://www.bodybuilding.com/exercises/hip-circles-prone"],
                            [3,4,"Seated Dumbell Press","4 sets 12 reps","https://www.bodybuilding.com/exercises/seated-dumbbell-press"],
                            [3,5,"Dumbell Shrug", "4 sets 10 reps", "https://www.bodybuilding.com/exercises/dumbbell-shrug"],
                            [3,6,"Face Pull", "3 sets 15 reps", "https://www.bodybuilding.com/exercises/face-pull"],
                            [3,7,"Cable Lift", "3 sets 20 reps", "https://www.bodybuilding.com/exercises/standing-cable-lift"],
                            [3,8,"Cable Crunch", "3 sets 20 reps","https://www.bodybuilding.com/exercises/cable-crunch"]
                        ],
                        [   #freq3, 2-2  Monday + Friday + Wednesday, Weightlifting: Gain Muscle:
                            ...
                            #WEDNESDAY BEGIN
                            [3,1,"Rotator Cuff Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.youtube.com/watch?v=bT8RNbaNd7U"],
                            [3,2,"One Arm Dumbell Press","4 sets 6 reps","https://www.bodybuilding.com/exercises/standing-palm-in-one-arm-dumbbell-press"],
                            [3,3,"Reverse Fly","3 sets 8 reps","https://www.bodybuilding.com/exercises/hip-circles-prone"],
                            [3,4,"Seated Dumbell Press","4 sets 8 reps","https://www.bodybuilding.com/exercises/seated-dumbbell-press"],
                            [3,5,"Dumbell Shrug", "4 sets 6 reps", "https://www.bodybuilding.com/exercises/dumbbell-shrug"],
                            [3,6,"Face Pull", "3 sets 10 reps", "https://www.bodybuilding.com/exercises/face-pull"],
                            [3,7,"Cable Lift", "3 sets 10 reps", "https://www.bodybuilding.com/exercises/standing-cable-lift"],
                            [3,8,"Cable Crunch", "3 sets 10 reps","https://www.bodybuilding.com/exercises/cable-crunch"]
                        ],
                ...
                [
                    [
                        [   #freq4, 1-1  Monday + Friday + Wednesday + Saturday, Cardio, Lose Weight
                            ...
                            [3,8,"Walk", "for 5 minutes","https://www.bodybuilding.com/exercises/walking-treadmill"],
                            #SATURDAY BEGIN
                            [6,1,"Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.bodybuilding.com/content/5-stretches-every-lifter-needs-to-do.html"],
                    ...
                    [
                        [   #freq4, 2-1  Monday + Friday + Wednesday + Saturday, Weightlifting: Lose Weight:
                            [1,1,"Rotator Cuff Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.youtube.com/watch?v=bT8RNbaNd7U"],
                            [1,2,"Barbell Rows","4 sets 10 reps","https://www.bodybuilding.com/exercises/reverse-grip-bent-over-rows"],
                            [1,3,"T-Bar Row","4 sets 10 reps","https://www.bodybuilding.com/exercises/t-bar-row-with-handle"],
                            [1,4,"Hyperextensions", "4 sets 15 reps", "https://www.bodybuilding.com/exercises/hyperextensions-back-extensions"],
                            ...
                            [3,1,"Rotator Cuff Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.youtube.com/watch?v=bT8RNbaNd7U"],
                            [3,2,"One Arm Dumbell Press","4 sets 12 reps","https://www.bodybuilding.com/exercises/standing-palm-in-one-arm-dumbbell-press"],
                            [3,3,"Reverse Fly","3 sets 15 reps","https://www.bodybuilding.com/exercises/reverse-flyes"],
                            [3,4,"Seated Dumbell Press","4 sets 12 reps","https://www.bodybuilding.com/exercises/seated-dumbbell-press"],
                            [3,5,"Dumbell Shrug", "4 sets 10 reps", "https://www.bodybuilding.com/exercises/dumbbell-shrug"],
                            [3,6,"Face Pull", "3 sets 15 reps", "https://www.bodybuilding.com/exercises/face-pull"],
                            [3,7,"Cable Lift", "3 sets 20 reps", "https://www.bodybuilding.com/exercises/standing-cable-lift"],
                            [3,8,"Cable Crunch", "3 sets 20 reps","https://www.bodybuilding.com/exercises/cable-crunch"],
                            #SATURDAY BEGIN
                            [6,1,"Rotator Cuff Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.youtube.com/watch?v=bT8RNbaNd7U"],
                        ...
                        [   #freq4, 2-2  Monday + Friday + Wednesday + Saturday, Weightlifting: Gain Muscle:
                            ...
                            [3,1,"Rotator Cuff Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.youtube.com/watch?v=bT8RNbaNd7U"],
                            [3,2,"One Arm Dumbell Press","4 sets 6 reps","https://www.bodybuilding.com/exercises/standing-palm-in-one-arm-dumbbell-press"],
                            [3,3,"Reverse Fly","3 sets 8 reps","https://www.bodybuilding.com/exercises/reverse-flyes"],
                            [3,4,"Seated Dumbell Press","4 sets 8 reps","https://www.bodybuilding.com/exercises/seated-dumbbell-press"],
                            [3,5,"Dumbell Shrug", "4 sets 6 reps", "https://www.bodybuilding.com/exercises/dumbbell-shrug"],
                            [3,6,"Face Pull", "3 sets 10 reps", "https://www.bodybuilding.com/exercises/face-pull"],
                            [3,7,"Cable Lift", "3 sets 10 reps", "https://www.bodybuilding.com/exercises/standing-cable-lift"],
                ...
                [
                    [
                        [  #freq5, 1-1  Monday + Friday + Wednesday + Saturday + Tuesday, Cardio, Lose Weight
                            ...
                            [6,7,"Walk", "for 5 more minutes","https://www.bodybuilding.com/exercises/walking-treadmill"],
                            #TUESDAY BEGIN
                            [2,1,"Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.bodybuilding.com/content/5-stretches-every-lifter-needs-to-do.html"],
                    ...
                    [
                        [   #freq5, 2-1  Monday + Friday + Wednesday + Saturday + Tuesday,
                            ...
                            [6,8,"Spider Curl", "4 sets 12 reps","https://www.bodybuilding.com/exercises/spider-curl"],
                            #TUESDAY BEGIN
                            [2,1,"Rotator Cuff Stretch","*THE MOST IMPORTANT PART OF EVERY WORKOUT*","https://www.youtube.com/watch?v=bT8RNbaNd7U"],
    ...
    q = (((db.userPlan.id == request.vars.planid)))
    db(q).delete()
    q = (((db.userAnswers.id == request.vars.planid)))
    db(q).delete()
    q = (((db.userWorkout.id == request.vars.planid)))
    db(q).delete()

    new_user_plan_id= db.userPlan.update_or_insert(
        user_email=auth.user.email,
        planName = request.vars.planname
    )


    new_user_answers_id = db.userAnswers.update_or_insert(
        userPlan_id = new_user_plan_id,
        question_id = 1,
        answer_id = request.vars.height
    )
    ...
    for workout in workouts[int(request.vars.freq)-1][int(request.vars.type)-1][int(request.vars.goals)-1]:
        new_user_workout_id = db.userWorkout.update_or_insert(
	        userPlan_id=new_user_plan_id,
...
@auth.requires_login()
def delete():
    q = (((db.userPlan.id == request.vars.id)))
    db(q).delete()
    q = (((db.userAnswers.id == request.vars.id)))
    db(q).delete()
    q = (((db.userWorkout.id == request.vars.id)))
    db(q).delete()